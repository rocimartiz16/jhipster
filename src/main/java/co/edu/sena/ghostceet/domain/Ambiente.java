...
public class Ambiente implements Serializable {
    ...
    @NotNull
    @Size(max = 10)
    @Column(name = "numero_ambiente", length = 10, nullable = false)
    ...
    @NotNull
    @Size(max = 40)
    @Column(name = "limitacion", length = 40, nullable = false)
    ...
    public Ambiente limitacion(String limitacion) {
