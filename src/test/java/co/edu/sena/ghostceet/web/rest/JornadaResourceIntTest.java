...
public class JornadaResourceIntTest {
    ...
    public void setup() {
        ...
        final JornadaResource jornadaResource = new JornadaResource(jornadaRepository);
    ...
    @Test
    @Transactional
    public void checkImagenUrlIsRequired() throws Exception {
        int databaseSizeBeforeTest = jornadaRepository.findAll().size();
        // set the field null
        jornada.setImagenUrl(null);
